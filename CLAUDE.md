...
Ola activa:  Ola 5 (Infraestructura)
Feature:     Ola 4 Templates (2/2 LOCKED) ✅ | Ola 3 Organisms (6/6 LOCKED) ✅
SPEC_ID:     EX-v2-INFRA (theme / i18n / strapi)
Último LOCK: CasePage (TMPL-002) — 2026-06-20
```
