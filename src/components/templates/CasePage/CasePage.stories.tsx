...
import { CLIENT_CASES, WORK_TEST_CASES } from '@/content/cases'

// Casos reales importados del contenido canónico — sin duplicar datos.
// Clientes: src/content/cases/clients/* · work-tests: src/content/cases/*.
const fdn = CLIENT_CASES.fdn
const bbva = CLIENT_CASES.bbva
const solidaria = WORK_TEST_CASES.solidaria
...
export const FDN: Story = {
  args: { caseData: fdn },
  name: 'FDN — Auditoría WCAG 2.1 AA (cliente)',
}

export const Solidaria: Story = {
  args: { caseData: solidaria },
  name: 'Solidaria — Diagnóstico autodirigido (work-test)',
}

export const BBVA: Story = {
  args: { caseData: bbva },
  name: 'BBVA — Sistema GEMAS (cliente)',
}
