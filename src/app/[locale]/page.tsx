...
> = {
  'correos-chile': { symptomTags: ['team-scaling', 'design-system'], roleTags: ['staff-architect', 'designops'], metric: { value: '400+', label: 'componentes sobre M3 (DS Merkén)' } },
  ...
  lasalle: { symptomTags: ['a11y', 'design-system'], roleTags: ['staff-architect', 'designops'], metric: { value: 'AAA', label: 'por alcance (vs. AA normativo)' } },
  'fid-seguros': { symptomTags: ['legacy', 'design-system'], roleTags: ['staff-architect', 'designops'], metric: { value: '~1.000', label: 'filas de gobierno D↔D' } },
